...
## [0.12.0](https://github.com/PolusAI/nyxus/compare/nyxus-v0.11.0...nyxus-v0.12.0) (2026-09-10)
...
* **2d zernike:** seed the angular tables at repetition 0, not 1 ([2eb3cc3](https://github.com/PolusAI/nyxus/commit/2eb3cc31988f41de103bf22d0355fb4d5d8c5d1d))
* **3d ngtdm:** default the neighbourhood radius so the family is not NaN ([53b04b5](https://github.com/PolusAI/nyxus/commit/53b04b53846e1b830cedbe0f7560a356c6d17dbc))
* **3d-ngldm:** DCNU/DCNUN summed the wrong marginal (== GLNU) ([d3198e5](https://github.com/PolusAI/nyxus/commit/d3198e5d80992ad93692ca93480f7e38d9efdd83))
...
* **feature_mgr:** extend check_11_correspondence() to Feature3D ([b188e50](https://github.com/PolusAI/nyxus/commit/b188e50c31014392057d98efb168f40f8d2cf63f))
* **feature_mgr:** loop 3D correspondence check from Feature3D::_FIRST_ ([9287f3c](https://github.com/PolusAI/nyxus/commit/9287f3ca2b369899e7f47c23acc4833d69f2edc4))
...
* **gabor:** keep filter-response magnitudes real-valued, then vet GABOR vs scikit-image ([2b2c7d7](https://github.com/PolusAI/nyxus/commit/2b2c7d7d84752d57883642ccfef738b55196287b))
...
* **gldzm:** build zones from the full 8-neighbourhood ([fc0bbde](https://github.com/PolusAI/nyxus/commit/fc0bbde8a1757e4a37804425685d7f51f9053013))
...
* **imq:** correct FOCUS_SCORE overflow + abs()-variance, vet 4 imq features vs OpenCV and CellProfiler ([7eed701](https://github.com/PolusAI/nyxus/commit/7eed70173cb88070962a9cddca169a55c1fe7d9f))
* **intensity_histogram:** report IH_ROBUST_MEAN_IDX as a 1-based bin index ([0527f48](https://github.com/PolusAI/nyxus/commit/0527f485bec818c35b73222eb46066a6e954e5fa))
...
* **morphology:** geodetic length/thickness from real perimeter (was size_t-truncated) ([ce7716f](https://github.com/PolusAI/nyxus/commit/ce7716ff2b853e96158f1a7885d1d62622638689))
* **morphology:** report ROI radii as distances, taken exactly ([5bb289b](https://github.com/PolusAI/nyxus/commit/5bb289b0d48358a10076ee82d4d6b87983fe9696))
...
* **ooc:** make the 2D out-of-core feature paths match the in-RAM path ([9a9ad02](https://github.com/PolusAI/nyxus/commit/9a9ad02e49f936f96f5b9e06dd9cfac2f104d61b))
* **python:** release an instance's Environment so a recycled id() cannot inherit it ([6dd550f](https://github.com/PolusAI/nyxus/commit/6dd550f340a6a396256a5abf0529e4ffb79d2ba8))
...
* **vetting:** band the 3D GLSZM entropy pin for a platform, not for a machine ([ab8573e](https://github.com/PolusAI/nyxus/commit/ab8573e67d9d486c7906305b5ddc159a1d71e561))
* **vetting:** correct radial follow-up records ([7c4657a](https://github.com/PolusAI/nyxus/commit/7c4657a10d5e420db19a379ca3a8c25b23b82815))
* **vetting:** let the NGTDM coverage scanner read one-line TEST registrations ([51df88e](https://github.com/PolusAI/nyxus/commit/51df88ee0a2ca67464f44f2b234004d2afaf67a4))
* **vetting:** normalize oracle_coverage.csv to LF, drop dead current_test notes ([7dc26ed](https://github.com/PolusAI/nyxus/commit/7dc26edb73069495bb12168920cb062a54e2ee31))
* **vetting:** write every generated CSV and report with LF ([91eb35e](https://github.com/PolusAI/nyxus/commit/91eb35e466658dd8e1a70564c073ac681ebcdf25))


### Performance Improvements

* **morphology:** read ROI radii from a distance transform where it is cheaper ([14a67eb](https://github.com/PolusAI/nyxus/commit/14a67ebf61e108032c2669fb101e666687d4a1bf))
...
* **3d gldzm:** record what the retired coverage sweep checked, and what it did not ([483dbbc](https://github.com/PolusAI/nyxus/commit/483dbbc9e9faa72f667378c2844914291e0f70ac))
* **3d ngldm:** say what the generator verifies, and what the Ns agreement proves ([9310932](https://github.com/PolusAI/nyxus/commit/93109320316d82059713f59c760903a9479f6e28))
...
* **imq:** say in the matrix that this pass vets the in-RAM paths only ([1591760](https://github.com/PolusAI/nyxus/commit/159176052b51214b9c208f1a25342eb77d7b3a8c))
* **morphology:** describe the ROI radius features rather than the change to them ([edb9f5d](https://github.com/PolusAI/nyxus/commit/edb9f5db5b303a80d34840759610e5516d182e2f))
...
* **vetting:** add the 2D morphology CellProfiler vetting report ([9d0db5f](https://github.com/PolusAI/nyxus/commit/9d0db5f5be865f1ef44863f635c1e6b8e83c3497))
* **vetting:** add the missing radial config matrix ([fe4ef56](https://github.com/PolusAI/nyxus/commit/fe4ef56eb260a0ef92e310f7e22588bb1d6b0e5c))
* **vetting:** audit the 2D GLCM goldens against fresh oracle runs ([0484103](https://github.com/PolusAI/nyxus/commit/0484103d1bf3661e39b81a54339722768119546f))
* **vetting:** audit the 2D GLRLM goldens against fresh oracle runs ([67f24ed](https://github.com/PolusAI/nyxus/commit/67f24ed946b99295a8d5fc14e2ed15a76b664c8c))
* **vetting:** correct 3D first-order oracle accounting ([f6ad06a](https://github.com/PolusAI/nyxus/commit/f6ad06a7d817886e80a2a04bbc1d117bb4236ad8))
...
* **vetting:** correct what the 3D first-order MATLAB oracle backs ([2ccd560](https://github.com/PolusAI/nyxus/commit/2ccd5608e46163ffa9849d360cb28bbb063aa7fe))
...
* **vetting:** drop the references to the deleted 3D morphology MATLAB header ([071b52d](https://github.com/PolusAI/nyxus/commit/071b52d2df60e370521b299460ff794496859776))
...
* **vetting:** give the constant-ROI cell a SPEC disposition, not an invented one ([834e59d](https://github.com/PolusAI/nyxus/commit/834e59da923f60c9dbebce20764017a4d7c39d95))
* **vetting:** give the neighbour rows a tier, a test name, a benchmark and a matrix ([7981b2a](https://github.com/PolusAI/nyxus/commit/7981b2a86e1b1b111d91b2c55e218d387167964b))
...
* **vetting:** lead the 3D first-order report with the current state ([004bfc5](https://github.com/PolusAI/nyxus/commit/004bfc51caf8570b29e24905cc40a40950d28b01))
* **vetting:** lead the 3D first-order report with the current state ([25c57f2](https://github.com/PolusAI/nyxus/commit/25c57f272d64c856557ed6821fa7960a9d1af3fe))
...
* **vetting:** name BasicMorphologyFeatures as MASS_DISPLACEMENT's producer ([d33a168](https://github.com/PolusAI/nyxus/commit/d33a1681698289e7d99d9714ce2d29cfab03b721))
* **vetting:** name Octave wherever the matlab oracle is presented ([d70e3fe](https://github.com/PolusAI/nyxus/commit/d70e3fe79c2fa43508f01d63adab6e557928c945))
* **vetting:** narrow what the 3D coverage sweep asserts that nothing else does ([2a75d34](https://github.com/PolusAI/nyxus/commit/2a75d34e47e9c890db99f26c2c66266ae1f2a9d0))
* **vetting:** record licensed 2D morphology provenance ([3d039d6](https://github.com/PolusAI/nyxus/commit/3d039d617f2f9f5560c874137064207ade2e4413))
...
* **vetting:** record the 2D GLDM audit ([3ee009d](https://github.com/PolusAI/nyxus/commit/3ee009d4bd02203357caee753ce501391a6cb0ab))
* **vetting:** record the 2D GLDZM audit ([f29924d](https://github.com/PolusAI/nyxus/commit/f29924d20ec1edc28f2c2ff64bebcf0630423566))
* **vetting:** record the 2D GLSZM audit ([176476a](https://github.com/PolusAI/nyxus/commit/176476a255bf4292c1b6b69ddfcb118f2e805518))
* **vetting:** record the 2D neighbour audit ([50d0ff8](https://github.com/PolusAI/nyxus/commit/50d0ff8850f09dbc229a6854868307bd4a3eb744))
* **vetting:** record the 2D NGTDM audit ([23c609f](https://github.com/PolusAI/nyxus/commit/23c609f8ef68bdaabda7c4c7558b5dd8ad061403))
* **vetting:** record the 3D GLDM default cell and the degenerate ROI it discards ([12ef315](https://github.com/PolusAI/nyxus/commit/12ef31588674e592dddad19f6b20beb3fd9e0fe8))
* **vetting:** record the 3D GLDM recipes, matrix, benchmarks and audit ([cac4e99](https://github.com/PolusAI/nyxus/commit/cac4e99dff997f24d79888e0c6f4a971a6da3a9b))
* **vetting:** record the 3D GLSZM audit, its recipes and its benchmark ([33e0fbe](https://github.com/PolusAI/nyxus/commit/33e0fbeda42e5c9c8f499d480418fa2bfb8180cc))
* **vetting:** record the 3D NGTDM audit, its recipes and its benchmark ([55d5e90](https://github.com/PolusAI/nyxus/commit/55d5e9002af1855b631d6646a2dc196ba7e2a677))
...
* **vetting:** record what the 3D GLSZM review round measured ([b7126de](https://github.com/PolusAI/nyxus/commit/b7126def4f9c883a3ef311d4c4927839d9e5f946))
...
* **vetting:** separate unproven provenance from unreproducible provenance ([058cb00](https://github.com/PolusAI/nyxus/commit/058cb00083e3b29b1ca05313f9bcd463bb5004c5))
* **vetting:** update golden_regen doc for the flat rel=1e-8 tolerance ([f84773f](https://github.com/PolusAI/nyxus/commit/f84773fe5ad83143f9e7072d9426753970114c03))


### Code Refactoring

* **3d surface:** describe the eigenvalue ordering rather than the defect it replaced ([34a74c2](https://github.com/PolusAI/nyxus/commit/34a74c26d51bde97cb3bbe8a2fe41a16a799bc57))
