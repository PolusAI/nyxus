...
## [0.12.0](https://github.com/PolusAI/nyxus/compare/nyxus-v0.11.0...nyxus-v0.12.0) (2026-09-21)
...
* **3d gldzm:** hold the ROI mark in the distance cube, and index the vetted features ([334936c](https://github.com/PolusAI/nyxus/commit/334936c34ade2b110f57f0e6c6eef9f6c4ed9219))
* **3d gldzm:** keep a ROI voxel whose grey level is zero, and say what the family costs ([ea9dd3a](https://github.com/PolusAI/nyxus/commit/ea9dd3a5f6cda073b2c1c04554451e5cdd487865))
* **3d gldzm:** over the ROI, at 26-connectivity, at the IBSI distance ([cf5d971](https://github.com/PolusAI/nyxus/commit/cf5d971a5d1a453f34c117aa2e20eaf139dfdbf9))
...
* **intensity:** keep a header-rescaled slide's stored integers, and carry the rescale in the inverse ([c79c822](https://github.com/PolusAI/nyxus/commit/c79c8224cbc41bed55ce7cf4a9475a30642d84e4))
* **intensity:** make the recorded map match what the loaders actually store ([ce5f74b](https://github.com/PolusAI/nyxus/commit/ce5f74b5d4194a4db7a3b6d8d7bbd005c60023ae))
* **intensity:** mirror the loaders' upper clamp, and survive degenerate input ([6bf9735](https://github.com/PolusAI/nyxus/commit/6bf9735afe342012d6b0c7df641008cb89b81405))
* **intensity:** one narrowing for every load-time map, saturated at both ends ([ed36627](https://github.com/PolusAI/nyxus/commit/ed36627660c0e3cb23edf72dc3aefac5e39cad7d))
* **intensity:** report first-order features in the slide's own intensity domain ([1a4e956](https://github.com/PolusAI/nyxus/commit/1a4e956b707c6c8308222c8ed2622f59f44dd1ad))
* **intensity:** restore the HU rounding, and finish the guards it skipped ([b243ff5](https://github.com/PolusAI/nyxus/commit/b243ff50e11cced9cb6de1fd6e0d169b729cbd04))
* **intensity:** settle a slide that measured nothing, and close the last unguarded cast ([f25d7e1](https://github.com/PolusAI/nyxus/commit/f25d7e1dc55f76ad7744efddf0e118438f29f687))
...
* **ngldm:** compute the 3D NGLDM over the ROI, over 26 neighbours, at the IBSI dependence count ([558aa79](https://github.com/PolusAI/nyxus/commit/558aa79464697208a5982d9c4efeaf550213cb10))
...
* **3d gldzm:** gather the ROI's mark and grey levels in one pass ([c37f58b](https://github.com/PolusAI/nyxus/commit/c37f58b9e97cd7dfbfcbdabc2a5b60c900255415))
...
* **ngldm:** build the 3D NGLDM from the ROI's voxels, in one pass for the mask and grey levels ([685da53](https://github.com/PolusAI/nyxus/commit/685da533e2d64ad18d8665aba0782e280766ddaf))
...
* **vetting:** correct the 3D NGLDM report's file-inventory claim, and widen the generator's shift ([1a762a1](https://github.com/PolusAI/nyxus/commit/1a762a199c73f23f0a5cb8c053fb954fe76dae0b))
...
* **vetting:** point the IMQ mechanics-guard comment at scan_other_tests ([bb1981c](https://github.com/PolusAI/nyxus/commit/bb1981c7c61b2e9cf427eb7c6e257ac68c75f4eb))
* **vetting:** record licensed 2D first-order provenance ([06ad1be](https://github.com/PolusAI/nyxus/commit/06ad1be1c267bdfdf85ae2c07eff342f1fe8ea33))
