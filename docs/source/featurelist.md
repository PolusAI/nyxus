...
| Nyxus feature code | Description
|--------------------|--------------
| 3D_INTEGRATED_INTENSITY | integrated intensity
| 3D_MEAN | mean
| 3D_MEDIAN | median
| 3D_MIN | minimum
| 3D_MAX | maximum
| 3D_RANGE | range
| 3D_STANDARD_DEVIATION | standard deviation
| 3D_STANDARD_ERROR | standard error
| 3D_SKEWNESS | skewness
| 3D_KURTOSIS | kurtosis
| 3D_HYPERSKEWNESS | heperskewness
| 3D_HYPERFLATNESS | hyperflatness
| 3D_MEAN_ABSOLUTE_DEVIATION | mean absolute deviation
| 3D_ENERGY | energy
| 3D_ROOT_MEAN_SQUARED | root mean squared
| 3D_ENTROPY | entropy
| 3D_MODE | mode
| 3D_UNIFORMITY | uniformity
| 3D_UNIFORMITY_PIU | uniformity in PI units
| 3D_P01, 3D_P10, 3D_P25, 3D_P75, 3D_P90, 3D_P99 | percentiles
| 3D_INTERQUARTILE_RANGE | interquartile range
| 3D_ROBUST_MEAN_ABSOLUTE_DEVIATION | robust (P10-90) mean absolute deviation
