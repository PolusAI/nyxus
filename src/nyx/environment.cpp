...
bool Environment::parse_cmdline(int argc, char** argv)
{
	...
	for (auto i = args.begin(); i != args.end(); ++i)
	{
		...
		if (!(
			...
			|| find_string_argument(i, clo_USE_PHYSICAL_SPACING, rawUsePhysicalSpacing)		// opt-in physical voxel spacing
	...
	//==== Parse the opt-in physical-spacing flag (default false)
