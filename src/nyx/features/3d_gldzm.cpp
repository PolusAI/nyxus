...
{
	fvals[static_cast<int>(Nyxus::Feature3D::GLDZM_SDE)][0] = f_SDE;
	fvals[static_cast<int>(Nyxus::Feature3D::GLDZM_LDE)][0] = f_LDE;
	fvals[static_cast<int>(Nyxus::Feature3D::GLDZM_LGLZE)][0] = f_LGLZE;
	fvals[static_cast<int>(Nyxus::Feature3D::GLDZM_HGLZE)][0] = f_HGLZE;
	fvals[static_cast<int>(Nyxus::Feature3D::GLDZM_SDLGLE)][0] = f_SDLGLE;
	fvals[static_cast<int>(Nyxus::Feature3D::GLDZM_SDHGLE)][0] = f_SDHGLE;
	fvals[static_cast<int>(Nyxus::Feature3D::GLDZM_LDLGLE)][0] = f_LDLGLE;
	fvals[static_cast<int>(Nyxus::Feature3D::GLDZM_LDHGLE)][0] = f_LDHGLE;
	fvals[static_cast<int>(Nyxus::Feature3D::GLDZM_GLNU)][0] = f_GLNU;
	fvals[static_cast<int>(Nyxus::Feature3D::GLDZM_GLNUN)][0] = f_GLNUN;
	fvals[static_cast<int>(Nyxus::Feature3D::GLDZM_ZDNU)][0] = f_ZDNU;
	fvals[static_cast<int>(Nyxus::Feature3D::GLDZM_ZDNUN)][0] = f_ZDNUN;
	fvals[static_cast<int>(Nyxus::Feature3D::GLDZM_ZP)][0] = f_ZP;
	fvals[static_cast<int>(Nyxus::Feature3D::GLDZM_GLM)][0] = f_GLM;
	fvals[static_cast<int>(Nyxus::Feature3D::GLDZM_GLV)][0] = f_GLV;
	fvals[static_cast<int>(Nyxus::Feature3D::GLDZM_ZDM)][0] = f_ZDM;
	fvals[static_cast<int>(Nyxus::Feature3D::GLDZM_ZDV)][0] = f_ZDV;
	fvals[static_cast<int>(Nyxus::Feature3D::GLDZM_ZDE)][0] = f_ZDE;
}
