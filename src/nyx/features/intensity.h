...
public:
	...
	// Out-of-core dispatch for intensity: route to the Dataset-taking osized_calculate, which
	// needs slide props for COVERED_IMAGE_INTENSITY_RANGE. The Dataset-less overload above is a
	// guard that throws, so the base osized_scan_whole_image cannot be used for this feature.
