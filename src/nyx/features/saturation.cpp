...
void SaturationFeature::calculate (LR& r, const Fsettings& s)
{
...
void SaturationFeature::extract (LR& r, const Fsettings& s)
{
	SaturationFeature f;
	f.calculate (r, s);
...
void SaturationFeature::parallel_process_1_batch (size_t firstitem, size_t lastitem, std::vector<int>* ptrLabels, std::unordered_map <int, LR>* ptrLabelData, const Fsettings & s, const Dataset & _)
{
...
void SaturationFeature::osized_calculate (LR& r, const Fsettings& s, ImageLoader& )
{
