...
namespace Nyxus
{
	std::map <std::string, Feature2D> UserFacingFeatureNames =
	{
		...
		{ "HISTOGRAM", Feature2D::HISTOGRAM },	// multi-valued: one frequency per histogram bin

		// IBSI Intensity Histogram family (46). IBSI-mode only.
		{ "IH_MEAN_VAL", Feature2D::IH_MEAN_VAL },
		{ "IH_VARIANCE_VAL", Feature2D::IH_VARIANCE_VAL },
		{ "IH_SKEWNESS_VAL", Feature2D::IH_SKEWNESS_VAL },
		{ "IH_EXCESS_KURTOSIS_VAL", Feature2D::IH_EXCESS_KURTOSIS_VAL },
		{ "IH_MEDIAN_VAL", Feature2D::IH_MEDIAN_VAL },
		{ "IH_MINIMUM_VAL", Feature2D::IH_MINIMUM_VAL },
		{ "IH_P10_VAL", Feature2D::IH_P10_VAL },
		{ "IH_P90_VAL", Feature2D::IH_P90_VAL },
		{ "IH_MAXIMUM_VAL", Feature2D::IH_MAXIMUM_VAL },
		{ "IH_MODE_VAL", Feature2D::IH_MODE_VAL },
		{ "IH_INTERQUANTILE_RANGE_VAL", Feature2D::IH_INTERQUANTILE_RANGE_VAL },
		{ "IH_RANGE_VAL", Feature2D::IH_RANGE_VAL },
		{ "IH_MEAN_ABSOLUTE_DEVIATION_VAL", Feature2D::IH_MEAN_ABSOLUTE_DEVIATION_VAL },
		{ "IH_ROBUST_MEAN_ABSOLUTE_DEVIATION_VAL", Feature2D::IH_ROBUST_MEAN_ABSOLUTE_DEVIATION_VAL },
		{ "IH_MEDIAN_ABSOLUTE_DEVIATION_VAL", Feature2D::IH_MEDIAN_ABSOLUTE_DEVIATION_VAL },
		{ "IH_COEFFICIENT_OF_VARIATION_VAL", Feature2D::IH_COEFFICIENT_OF_VARIATION_VAL },
		{ "IH_QUANTILE_COEFFICIENT_OF_DISPERSION_VAL", Feature2D::IH_QUANTILE_COEFFICIENT_OF_DISPERSION_VAL },
		{ "IH_ENTROPY_VAL", Feature2D::IH_ENTROPY_VAL },
		{ "IH_UNIFORMITY_VAL", Feature2D::IH_UNIFORMITY_VAL },
		{ "IH_ROBUST_MEAN_VAL", Feature2D::IH_ROBUST_MEAN_VAL },
		{ "IH_MEAN_IDX", Feature2D::IH_MEAN_IDX },
		{ "IH_VARIANCE_IDX", Feature2D::IH_VARIANCE_IDX },
		{ "IH_SKEWNESS_IDX", Feature2D::IH_SKEWNESS_IDX },
		{ "IH_EXCESS_KURTOSIS_IDX", Feature2D::IH_EXCESS_KURTOSIS_IDX },
		{ "IH_MEDIAN_IDX", Feature2D::IH_MEDIAN_IDX },
		{ "IH_MINIMUM_IDX", Feature2D::IH_MINIMUM_IDX },
		{ "IH_P10_IDX", Feature2D::IH_P10_IDX },
		{ "IH_P90_IDX", Feature2D::IH_P90_IDX },
		{ "IH_MAXIMUM_IDX", Feature2D::IH_MAXIMUM_IDX },
		{ "IH_MODE_IDX", Feature2D::IH_MODE_IDX },
		{ "IH_INTERQUANTILE_RANGE_IDX", Feature2D::IH_INTERQUANTILE_RANGE_IDX },
		{ "IH_RANGE_IDX", Feature2D::IH_RANGE_IDX },
		{ "IH_MEAN_ABSOLUTE_DEVIATION_IDX", Feature2D::IH_MEAN_ABSOLUTE_DEVIATION_IDX },
		{ "IH_ROBUST_MEAN_ABSOLUTE_DEVIATION_IDX", Feature2D::IH_ROBUST_MEAN_ABSOLUTE_DEVIATION_IDX },
		{ "IH_MEDIAN_ABSOLUTE_DEVIATION_IDX", Feature2D::IH_MEDIAN_ABSOLUTE_DEVIATION_IDX },
		{ "IH_COEFFICIENT_OF_VARIATION_IDX", Feature2D::IH_COEFFICIENT_OF_VARIATION_IDX },
		{ "IH_QUANTILE_COEFFICIENT_OF_DISPERSION_IDX", Feature2D::IH_QUANTILE_COEFFICIENT_OF_DISPERSION_IDX },
		{ "IH_ENTROPY_IDX", Feature2D::IH_ENTROPY_IDX },
		{ "IH_UNIFORMITY_IDX", Feature2D::IH_UNIFORMITY_IDX },
		{ "IH_MAX_GRADIENT", Feature2D::IH_MAX_GRADIENT },
		{ "IH_MAX_GRADIENT_IDX", Feature2D::IH_MAX_GRADIENT_IDX },
		{ "IH_MIN_GRADIENT", Feature2D::IH_MIN_GRADIENT },
		{ "IH_MIN_GRADIENT_IDX", Feature2D::IH_MIN_GRADIENT_IDX },
		{ "IH_ROBUST_MEAN_IDX", Feature2D::IH_ROBUST_MEAN_IDX },
		{ "IH_NUM_BINS", Feature2D::IH_NUM_BINS },
		{ "IH_BIN_SIZE", Feature2D::IH_BIN_SIZE },
	...
	std::map <std::string, Feature3D> UserFacing_3D_featureNames =
	{
		...
		{ "3GLSZM_SAE", Feature3D::GLSZM_SAE },
		{ "3GLSZM_LAE", Feature3D::GLSZM_LAE },
		{ "3GLSZM_GLN", Feature3D::GLSZM_GLN },
		{ "3GLSZM_GLNN", Feature3D::GLSZM_GLNN },
		{ "3GLSZM_SZN", Feature3D::GLSZM_SZN },
		{ "3GLSZM_SZNN", Feature3D::GLSZM_SZNN },
		{ "3GLSZM_ZP", Feature3D::GLSZM_ZP },
		{ "3GLSZM_GLV", Feature3D::GLSZM_GLV },
		{ "3GLSZM_ZV", Feature3D::GLSZM_ZV },
		{ "3GLSZM_ZE", Feature3D::GLSZM_ZE },
		{ "3GLSZM_LGLZE", Feature3D::GLSZM_LGLZE },
		{ "3GLSZM_HGLZE", Feature3D::GLSZM_HGLZE },
		{ "3GLSZM_SALGLE", Feature3D::GLSZM_SALGLE },
		{ "3GLSZM_SAHGLE", Feature3D::GLSZM_SAHGLE },
		{ "3GLSZM_LALGLE", Feature3D::GLSZM_LALGLE },
		{ "3GLSZM_LAHGLE", Feature3D::GLSZM_LAHGLE },
