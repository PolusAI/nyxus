...
namespace Nyxus
{
		...
		const std::string& outputPath)
	{
		...
		if (write_apache) {
			...
			auto [status, msg] = theEnvironment.arrow_stream.create_arrow_file(saveOption, outputPath, theEnvironment.nyxus_result_fname, Nyxus::get_header(theFeatureSet.getEnabledFeatures()));
