...
silently wrong feature row. The trivial == out-of-core value invariant lives in test_2d_ooc_invariant.py.
...
def test_2d_ooc_montage_oversized_fails_loudly_mechanics():
