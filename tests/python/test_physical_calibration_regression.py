...
declared unit (a Z axis in a different unit than X/Y would otherwise report its value under
X/Y's unit string).
...
def test_ometiff_micrometer_and_nanometer_stores_agree_regression(tmp_path):
