...
static const std::vector<GeomomentExpectation> shape_geomoment_expectations{
	...
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::NORM_SPAT_MOMENT_00, "NORM_SPAT_MOMENT_00", 1),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::NORM_SPAT_MOMENT_01, "NORM_SPAT_MOMENT_01", 0.44502457797294748),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::NORM_SPAT_MOMENT_02, "NORM_SPAT_MOMENT_02", 0.26744791666666667),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::NORM_SPAT_MOMENT_03, "NORM_SPAT_MOMENT_03", 0.18079123480150991),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::NORM_SPAT_MOMENT_10, "NORM_SPAT_MOMENT_10", 0.53631167089047516),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::NORM_SPAT_MOMENT_11, "NORM_SPAT_MOMENT_11", 0.23867187500000001),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::NORM_SPAT_MOMENT_12, "NORM_SPAT_MOMENT_12", 0.14343543906367653),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::NORM_SPAT_MOMENT_13, "NORM_SPAT_MOMENT_13", 0.096960449218749994),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::NORM_SPAT_MOMENT_20, "NORM_SPAT_MOMENT_20", 0.38758680555555558),
	...
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::NORM_SPAT_MOMENT_23, "NORM_SPAT_MOMENT_23", 0.070072297169161621),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::NORM_SPAT_MOMENT_30, "NORM_SPAT_MOMENT_30", 0.31508310664815414),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::NORM_SPAT_MOMENT_31, "NORM_SPAT_MOMENT_31", 0.14021972656250001),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::NORM_SPAT_MOMENT_32, "NORM_SPAT_MOMENT_32", 0.084268320449909992),
...
static const std::vector<GeomomentExpectation> shape_weighted_geomoment_expectations{
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::WEIGHTED_SPAT_MOMENT_00, "WEIGHTED_SPAT_MOMENT_00", 2498.7137745347236),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::WEIGHTED_SPAT_MOMENT_01, "WEIGHTED_SPAT_MOMENT_01", 56490.467057333364),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::WEIGHTED_SPAT_MOMENT_02, "WEIGHTED_SPAT_MOMENT_02", 1384474.7445020285),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::WEIGHTED_SPAT_MOMENT_03, "WEIGHTED_SPAT_MOMENT_03", 37605700.456672639),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::WEIGHTED_SPAT_MOMENT_10, "WEIGHTED_SPAT_MOMENT_10", 66428.864797854694),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::WEIGHTED_SPAT_MOMENT_11, "WEIGHTED_SPAT_MOMENT_11", 1505032.6106230586),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::WEIGHTED_SPAT_MOMENT_12, "WEIGHTED_SPAT_MOMENT_12", 37215299.240302473),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::WEIGHTED_SPAT_MOMENT_20, "WEIGHTED_SPAT_MOMENT_20", 1970501.3917437526),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::WEIGHTED_SPAT_MOMENT_21, "WEIGHTED_SPAT_MOMENT_21", 45088115.602599062),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::WEIGHTED_SPAT_MOMENT_30, "WEIGHTED_SPAT_MOMENT_30", 65035567.600335725),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::WEIGHTED_CENTRAL_MOMENT_02, "WEIGHTED_CENTRAL_MOMENT_02", 108271.66085414639),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::WEIGHTED_CENTRAL_MOMENT_03, "WEIGHTED_CENTRAL_MOMENT_03", 1648221.2155424568),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::WEIGHTED_CENTRAL_MOMENT_11, "WEIGHTED_CENTRAL_MOMENT_11", 4109.7206134559083),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::WEIGHTED_CENTRAL_MOMENT_12, "WEIGHTED_CENTRAL_MOMENT_12", 330371.75284171134),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::WEIGHTED_CENTRAL_MOMENT_20, "WEIGHTED_CENTRAL_MOMENT_20", 205330.93384081553),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::WEIGHTED_CENTRAL_MOMENT_21, "WEIGHTED_CENTRAL_MOMENT_21", 496695.03645982972),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::WEIGHTED_CENTRAL_MOMENT_30, "WEIGHTED_CENTRAL_MOMENT_30", 2136803.5531487665),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::WT_NORM_CTR_MOM_02, "WT_NORM_CTR_MOM_02", 0.017341305008900215),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::WT_NORM_CTR_MOM_03, "WT_NORM_CTR_MOM_03", 0.0052810979515541092),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::WT_NORM_CTR_MOM_11, "WT_NORM_CTR_MOM_11", 0.00065823243217178482),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::WT_NORM_CTR_MOM_12, "WT_NORM_CTR_MOM_12", 0.0010585506185281591),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::WT_NORM_CTR_MOM_20, "WT_NORM_CTR_MOM_20", 0.032886780561097596),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::WT_NORM_CTR_MOM_21, "WT_NORM_CTR_MOM_21", 0.0015914703165204656),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::WT_NORM_CTR_MOM_30, "WT_NORM_CTR_MOM_30", 0.0068465742104244923),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::WEIGHTED_HU_M1, "WEIGHTED_HU_M1", 0.050228085569997812),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::WEIGHTED_HU_M2, "WEIGHTED_HU_M2", 0.00024339488988301761),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::WEIGHTED_HU_M3, "WEIGHTED_HU_M3", 1.3732402653252524e-05),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::WEIGHTED_HU_M4, "WEIGHTED_HU_M4", 0.00010972319316066924),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::WEIGHTED_HU_M5, "WEIGHTED_HU_M5", -4.0924793325555725e-09),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::WEIGHTED_HU_M6, "WEIGHTED_HU_M6", 0.0052813682812053835),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::WEIGHTED_HU_M7, "WEIGHTED_HU_M7", -3.2208361663964004e-09),
};
...
static const std::vector<GeomomentExpectation> intensity_geomoment_expectations{
	...
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::IMOM_NRM_00, "IMOM_NRM_00", 1),
	...
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::IMOM_NRM_03, "IMOM_NRM_03", 9.9517462450555541e-05),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::IMOM_NRM_10, "IMOM_NRM_10", 0.045341630166175047),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::IMOM_NRM_11, "IMOM_NRM_11", 0.0017522720110346945),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::IMOM_NRM_12, "IMOM_NRM_12", 8.3759678499449274e-05),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::IMOM_NRM_13, "IMOM_NRM_13", 4.3766925283775395e-06),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::IMOM_NRM_20, "IMOM_NRM_20", 0.0025799842045067059),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::IMOM_NRM_21, "IMOM_NRM_21", 9.8925677672061715e-05),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::IMOM_NRM_22, "IMOM_NRM_22", 4.7143264687233126e-06),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::IMOM_NRM_23, "IMOM_NRM_23", 2.4593093284379381e-07),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::IMOM_NRM_30, "IMOM_NRM_30", 0.00016122941125190971),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::IMOM_NRM_31, "IMOM_NRM_31", 6.1552927901407291e-06),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::IMOM_NRM_32, "IMOM_NRM_32", 2.9283383602959163e-07),
...
static const std::vector<GeomomentExpectation> intensity_weighted_geomoment_expectations{
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::IMOM_WRM_00, "IMOM_WRM_00", 512893.00982429727),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::IMOM_WRM_01, "IMOM_WRM_01", 12144895.632545877),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::IMOM_WRM_02, "IMOM_WRM_02", 317009217.47022206),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::IMOM_WRM_03, "IMOM_WRM_03", 8987339922.381422),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::IMOM_WRM_10, "IMOM_WRM_10", 14267758.335710838),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::IMOM_WRM_11, "IMOM_WRM_11", 340242564.82820618),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::IMOM_WRM_12, "IMOM_WRM_12", 8924143257.7546329),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::IMOM_WRM_20, "IMOM_WRM_20", 445196520.83852273),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::IMOM_WRM_21, "IMOM_WRM_21", 10672248980.453976),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::IMOM_WRM_30, "IMOM_WRM_30", 15212433464.582859),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::IMOM_WCM_02, "IMOM_WCM_02", 29664420.570163991),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::IMOM_WCM_03, "IMOM_WCM_03", 147284035.25422412),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::IMOM_WCM_11, "IMOM_WCM_11", 2678500.1290065008),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::IMOM_WCM_12, "IMOM_WCM_12", 19690079.853762936),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::IMOM_WCM_20, "IMOM_WCM_20", 48636574.87205068),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::IMOM_WCM_21, "IMOM_WCM_21", 34138173.79962717),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::IMOM_WCM_30, "IMOM_WCM_30", 259829644.49042335),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::IMOM_WNCM_02, "IMOM_WNCM_02", 0.00011276707339208047),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::IMOM_WNCM_03, "IMOM_WNCM_03", 7.8178750321206185e-07),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::IMOM_WNCM_11, "IMOM_WNCM_11", 1.0182117662266657e-05),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::IMOM_WNCM_12, "IMOM_WNCM_12", 1.0451545777075632e-07),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::IMOM_WNCM_20, "IMOM_WNCM_20", 0.00018488829725035266),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::IMOM_WNCM_21, "IMOM_WNCM_21", 1.8120631752764605e-07),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::IMOM_WNCM_30, "IMOM_WNCM_30", 1.3791825344547646e-06),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::IMOM_WHU1, "IMOM_WHU1", 0.00029765537064243316),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::IMOM_WHU2, "IMOM_WHU2", 5.6161730111679807e-09),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::IMOM_WHU3, "IMOM_WHU3", 1.1923046864432925e-12),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::IMOM_WHU4, "IMOM_WHU4", 3.1287168309169019e-12),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::IMOM_WHU5, "IMOM_WHU5", -5.2494915279842729e-24),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::IMOM_WHU6, "IMOM_WHU6", 7.8178750331489451e-07),
	unvetted_no_direct_oracle_geomoment(Nyxus::Feature2D::IMOM_WHU7, "IMOM_WHU7", -5.6202519491182231e-24),
};
