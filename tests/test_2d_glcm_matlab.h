...
// (oracle_coverage.csv, target_test=test_2d_glcm_matlab.h): ASM, CONTRAST, CORRELATION, ENERGY, HOM1
// and their angle-averaged _AVE twins. They were asserted in test_2d_glcm_regression.h; SPEC 2 keeps
...
// test_2d_glcm_regression.h, which carry no MATLAB version, config or generator. The registry is the
