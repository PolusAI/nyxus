...
void assert_compat_3glcm_feature (const Nyxus::Feature3D& expecting_fcode, const std::string& fname)
{
    // (1) prepare
...
{
    assert_compat_3glcm_feature (Nyxus::Feature3D::GLCM_ACOR, "3GLCM_ACOR");
}

void test_3d_glcm_angular_2d_moment_pyradiomics()
{
    assert_compat_3glcm_feature (Nyxus::Feature3D::GLCM_ASM, "3GLCM_ASM");
}

void test_3d_glcm_cluprom_pyradiomics()
{
    assert_compat_3glcm_feature (Nyxus::Feature3D::GLCM_CLUPROM, "3GLCM_CLUPROM");
}

void test_3d_glcm_clushade_pyradiomics()
{
    assert_compat_3glcm_feature (Nyxus::Feature3D::GLCM_CLUSHADE, "3GLCM_CLUSHADE");
}

void test_3d_glcm_clutend_pyradiomics()
{
    assert_compat_3glcm_feature (Nyxus::Feature3D::GLCM_CLUTEND, "3GLCM_CLUTEND");
}

void test_3d_glcm_contrast_pyradiomics()
{
    assert_compat_3glcm_feature (Nyxus::Feature3D::GLCM_CONTRAST, "3GLCM_CONTRAST");
}

void test_3d_glcm_correlation_pyradiomics()
{
    assert_compat_3glcm_feature (Nyxus::Feature3D::GLCM_CORRELATION, "3GLCM_CORRELATION");
}

void test_3d_glcm_difference_average_pyradiomics()
{
    assert_compat_3glcm_feature (Nyxus::Feature3D::GLCM_DIFAVE, "3GLCM_DIFAVE");
}

void test_3d_glcm_difference_entropy_pyradiomics()
{
    assert_compat_3glcm_feature (Nyxus::Feature3D::GLCM_DIFENTRO, "3GLCM_DIFENTRO");
}

void test_3d_glcm_difference_variance_pyradiomics()
{
    assert_compat_3glcm_feature (Nyxus::Feature3D::GLCM_DIFVAR, "3GLCM_DIFVAR");
}

void test_3d_glcm_id_pyradiomics()
{
    assert_compat_3glcm_feature (Nyxus::Feature3D::GLCM_ID, "3GLCM_ID");
}

void test_3d_glcm_idn_pyradiomics()
{
    assert_compat_3glcm_feature (Nyxus::Feature3D::GLCM_IDN, "3GLCM_IDN");
}

void test_3d_glcm_idm_pyradiomics()
{
    assert_compat_3glcm_feature (Nyxus::Feature3D::GLCM_IDM, "3GLCM_IDM");
}

void test_3d_glcm_idmn_pyradiomics()
{
    assert_compat_3glcm_feature (Nyxus::Feature3D::GLCM_IDMN, "3GLCM_IDMN");
}

void test_3d_glcm_infomeas1_pyradiomics()
{
    assert_compat_3glcm_feature (Nyxus::Feature3D::GLCM_INFOMEAS1, "3GLCM_INFOMEAS1");
}

void test_3d_glcm_infomeas2_pyradiomics()
{
    assert_compat_3glcm_feature (Nyxus::Feature3D::GLCM_INFOMEAS2, "3GLCM_INFOMEAS2");
}

void test_3d_glcm_iv_pyradiomics()
{
    assert_compat_3glcm_feature (Nyxus::Feature3D::GLCM_IV, "3GLCM_IV");
}

void test_3d_glcm_jave_pyradiomics()
{
    assert_compat_3glcm_feature (Nyxus::Feature3D::GLCM_JAVE, "3GLCM_JAVE");
}

void test_3d_glcm_je_pyradiomics()
{
    assert_compat_3glcm_feature (Nyxus::Feature3D::GLCM_JE, "3GLCM_JE");
}

void test_3d_glcm_jmax_pyradiomics()
{
    assert_compat_3glcm_feature (Nyxus::Feature3D::GLCM_JMAX, "3GLCM_JMAX");
}

void test_3d_glcm_jvar_pyradiomics()
{
    assert_compat_3glcm_feature (Nyxus::Feature3D::GLCM_JVAR, "3GLCM_JVAR");
}

void test_3d_glcm_sum_average_pyradiomics()
{
    assert_compat_3glcm_feature (Nyxus::Feature3D::GLCM_SUMAVERAGE, "3GLCM_SUMAVERAGE");
}

void test_3d_glcm_sum_entropy_pyradiomics()
{
    assert_compat_3glcm_feature (Nyxus::Feature3D::GLCM_SUMENTROPY, "3GLCM_SUMENTROPY");
}
