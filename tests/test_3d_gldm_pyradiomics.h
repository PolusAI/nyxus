...
void assert_3d_gldm_feature_pyradiomics (const Nyxus::Feature3D & expecting_fcode, const std::string & fname)
{
    // (1) prepare

    // check that requested feature exists
    auto iter = gldm_3d_pyradiomics_ref_vals.find (fname);
    ASSERT_TRUE (iter != gldm_3d_pyradiomics_ref_vals.end());
...
void test_3d_gldm_de_pyradiomics() { 
    assert_3d_gldm_feature_pyradiomics(Nyxus::Feature3D::GLDM_DE, "3GLDM_DE"); 
}

void test_3d_gldm_dn_pyradiomics() { 
    assert_3d_gldm_feature_pyradiomics(Nyxus::Feature3D::GLDM_DN, "3GLDM_DN"); 
}

void test_3d_gldm_dnn_pyradiomics() { 
    assert_3d_gldm_feature_pyradiomics(Nyxus::Feature3D::GLDM_DNN, "3GLDM_DNN"); 
}

void test_3d_gldm_dv_pyradiomics() { 
    assert_3d_gldm_feature_pyradiomics(Nyxus::Feature3D::GLDM_DV, "3GLDM_DV"); 
}

void test_3d_gldm_gln_pyradiomics() { 
    assert_3d_gldm_feature_pyradiomics(Nyxus::Feature3D::GLDM_GLN, "3GLDM_GLN"); 
}

void test_3d_gldm_glv_pyradiomics() { 
    assert_3d_gldm_feature_pyradiomics(Nyxus::Feature3D::GLDM_GLV, "3GLDM_GLV"); 
}

void test_3d_gldm_hgle_pyradiomics() { 
    assert_3d_gldm_feature_pyradiomics(Nyxus::Feature3D::GLDM_HGLE, "3GLDM_HGLE"); 
}

void test_3d_gldm_lde_pyradiomics() { 
    assert_3d_gldm_feature_pyradiomics(Nyxus::Feature3D::GLDM_LDE, "3GLDM_LDE"); 
}

void test_3d_gldm_ldhgle_pyradiomics() { 
    assert_3d_gldm_feature_pyradiomics(Nyxus::Feature3D::GLDM_LDHGLE, "3GLDM_LDHGLE"); 
}

void test_3d_gldm_ldlgle_pyradiomics() { 
    assert_3d_gldm_feature_pyradiomics(Nyxus::Feature3D::GLDM_LDLGLE, "3GLDM_LDLGLE"); 
}

void test_3d_gldm_lgle_pyradiomics() { 
    assert_3d_gldm_feature_pyradiomics(Nyxus::Feature3D::GLDM_LGLE, "3GLDM_LGLE");
}

void test_3d_gldm_sde_pyradiomics() { 
    assert_3d_gldm_feature_pyradiomics(Nyxus::Feature3D::GLDM_SDE, "3GLDM_SDE"); 
}

void test_3d_gldm_sdhgle_pyradiomics() { 
    assert_3d_gldm_feature_pyradiomics(Nyxus::Feature3D::GLDM_SDHGLE, "3GLDM_SDHGLE"); 
}

void test_3d_gldm_sdlgle_pyradiomics() { 
    assert_3d_gldm_feature_pyradiomics(Nyxus::Feature3D::GLDM_SDLGLE, "3GLDM_SDLGLE"); 
}
