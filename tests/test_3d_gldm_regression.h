...
// (orphaned legacy GT table; live 3D GLDM oracle is test_3d_gldm_pyradiomics.h).
...
// file only re-instantiates the two suites for the "gldm" family. Every public 3D feature is
...
INSTANTIATE_TEST_SUITE_P(
	GLDM_UNVETTED_LOCAL_REGRESSION,
	Test3DFeature_UNVETTED_LOCAL_REGRESSION,
	testing::ValuesIn(feature_3d_cases_for_family("gldm", false)),
	sanitize_3d_feature_test_name);
