...
void assert_compat_3glrlm_feature(const Nyxus::Feature3D& expecting_fcode, const std::string& fname)
{
    // (1) prepare
...
// (assert_compat_3glrlm_feature: atot = calc_ave(fvals[X])). So reading the _AVE slot directly and
...
void test_3d_glrlm_gln_pyradiomics() {
    assert_compat_3glrlm_feature (Nyxus::Feature3D::GLRLM_GLN, "3GLRLM_GLN");
}

void test_3d_glrlm_glnn_pyradiomics() {
    assert_compat_3glrlm_feature (Nyxus::Feature3D::GLRLM_GLNN, "3GLRLM_GLNN");
}

void test_3d_glrlm_glv_pyradiomics() {
    assert_compat_3glrlm_feature (Nyxus::Feature3D::GLRLM_GLV, "3GLRLM_GLV");
}

void test_3d_glrlm_hglre_pyradiomics() {
    assert_compat_3glrlm_feature (Nyxus::Feature3D::GLRLM_HGLRE, "3GLRLM_HGLRE");
}

void test_3d_glrlm_lre_pyradiomics() {
    assert_compat_3glrlm_feature (Nyxus::Feature3D::GLRLM_LRE, "3GLRLM_LRE");
}

void test_3d_glrlm_lrhgle_pyradiomics() {
    assert_compat_3glrlm_feature (Nyxus::Feature3D::GLRLM_LRHGLE, "3GLRLM_LRHGLE");
}

void test_3d_glrlm_lrlgle_pyradiomics() {
    assert_compat_3glrlm_feature (Nyxus::Feature3D::GLRLM_LRLGLE, "3GLRLM_LRLGLE");
}

void test_3d_glrlm_lglre_pyradiomics() {
    assert_compat_3glrlm_feature (Nyxus::Feature3D::GLRLM_LGLRE, "3GLRLM_LGLRE");
}

void test_3d_glrlm_re_pyradiomics() {
    assert_compat_3glrlm_feature (Nyxus::Feature3D::GLRLM_RE, "3GLRLM_RE");
}

void test_3d_glrlm_rln_pyradiomics() {
    assert_compat_3glrlm_feature (Nyxus::Feature3D::GLRLM_RLN, "3GLRLM_RLN");
}

void test_3d_glrlm_rlnn_pyradiomics() {
    assert_compat_3glrlm_feature (Nyxus::Feature3D::GLRLM_RLNN, "3GLRLM_RLNN");
}

void test_3d_glrlm_rp_pyradiomics() {
    assert_compat_3glrlm_feature (Nyxus::Feature3D::GLRLM_RP, "3GLRLM_RP");
}

void test_3d_glrlm_rv_pyradiomics() {
    assert_compat_3glrlm_feature (Nyxus::Feature3D::GLRLM_RV, "3GLRLM_RV");
}

void test_3d_glrlm_sre_pyradiomics() {
    assert_compat_3glrlm_feature (Nyxus::Feature3D::GLRLM_SRE, "3GLRLM_SRE");
}

void test_3d_glrlm_srhgle_pyradiomics() {
    assert_compat_3glrlm_feature (Nyxus::Feature3D::GLRLM_SRHGLE, "3GLRLM_SRHGLE");
}

void test_3d_glrlm_srlgle_pyradiomics() {
    assert_compat_3glrlm_feature (Nyxus::Feature3D::GLRLM_SRLGLE, "3GLRLM_SRLGLE");
}
