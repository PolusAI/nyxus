...
void assert_3ngtdm_feature(const Nyxus::Feature3D& expecting_fcode, const std::string& fname)
{
#if 0
    // get segment info
...
{
    assert_3ngtdm_feature(Nyxus::Feature3D::NGTDM_COARSENESS, "3NGTDM_COARSENESS");
}

void test_3d_ngtdm_contrast_regression()
{
    assert_3ngtdm_feature(Nyxus::Feature3D::NGTDM_CONTRAST, "3NGTDM_CONTRAST");
}

void test_3d_ngtdm_busyness_regression()
{
    assert_3ngtdm_feature(Nyxus::Feature3D::NGTDM_BUSYNESS, "3NGTDM_BUSYNESS");
}

void test_3d_ngtdm_complexity_regression()
{
    assert_3ngtdm_feature(Nyxus::Feature3D::NGTDM_COMPLEXITY, "3NGTDM_COMPLEXITY");
}

void test_3d_ngtdm_strength_regression()
{
    assert_3ngtdm_feature(Nyxus::Feature3D::NGTDM_STRENGTH, "3NGTDM_STRENGTH");
}
