...
TEST(TEST_NYXUS, TEST_GLCM_ASM_IBSI)
{
	ASSERT_NO_THROW(test_glcm_asm_ibsi());
}
...
TEST(TEST_NYXUS, TEST_GLCM_ASM_MATLAB)
{
	ASSERT_NO_THROW(test_glcm_asm_matlab());
}
...
TEST(TEST_NYXUS, TEST_GLCM_CONTRAST_MATLAB)
{
	ASSERT_NO_THROW(test_glcm_contrast_matlab());
}

TEST(TEST_NYXUS, TEST_GLCM_CORRELATION_MATLAB)
{
	ASSERT_NO_THROW(test_glcm_correlation_matlab());
}
...
TEST(TEST_NYXUS, TEST_GLCM_ENERGY_MATLAB)
{
	ASSERT_NO_THROW(test_glcm_energy_matlab());
}
...
TEST(TEST_NYXUS, TEST_GLCM_HOM1_MATLAB)
{
	ASSERT_NO_THROW(test_glcm_hom1_matlab());
}
...
TEST(TEST_NYXUS, TEST_GLCM_ASM_AVE_MATLAB)
{
	ASSERT_NO_THROW(test_glcm_asm_ave_matlab());
}
...
TEST(TEST_NYXUS, TEST_GLCM_CONTRAST_AVE_MATLAB)
{
	ASSERT_NO_THROW(test_glcm_contrast_ave_matlab());
}

TEST(TEST_NYXUS, TEST_GLCM_CORRELATION_AVE_MATLAB)
{
	ASSERT_NO_THROW(test_glcm_correlation_ave_matlab());
}

TEST(TEST_NYXUS, TEST_GLCM_DIFFERENCE_AVERAGE_AVE_REGRESSION)
{
	ASSERT_NO_THROW(test_glcm_difference_average_ave_regression());
}

TEST(TEST_NYXUS, TEST_GLCM_DIFFERENCE_ENTROPY_AVE_REGRESSION)
{
	ASSERT_NO_THROW(test_glcm_difference_entropy_ave_regression());
}

TEST(TEST_NYXUS, TEST_GLCM_DIFFERENCE_VARIANCE_AVE_REGRESSION)
{
	ASSERT_NO_THROW(test_glcm_difference_variance_ave_regression());
}
...
TEST(TEST_NYXUS, TEST_GLCM_ENERGY_AVE_MATLAB)
{
	ASSERT_NO_THROW(test_glcm_energy_ave_matlab());
}
...
TEST(TEST_NYXUS, TEST_GLCM_HOM1_AVE_MATLAB)
{
	ASSERT_NO_THROW(test_glcm_hom1_ave_matlab());
}
...
TEST(TEST_NYXUS, TEST_GLCM_SUM_AVERAGE_AVE_REGRESSION)
{
	ASSERT_NO_THROW(test_glcm_sum_average_ave_regression());
}

TEST(TEST_NYXUS, TEST_GLCM_SUM_ENTROPY_AVE_REGRESSION)
{
	ASSERT_NO_THROW(test_glcm_sum_entropy_ave_regression());
}

TEST(TEST_NYXUS, TEST_GLCM_SUM_VARIANCE_AVE_REGRESSION)
{
	ASSERT_NO_THROW(test_glcm_sum_variance_ave_regression());
}
