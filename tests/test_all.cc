...
TEST(TEST_NYXUS, TEST_3D_FIRSTORDER_P10_PYRADIOMICS){
	ASSERT_NO_THROW(assert_compat_radiomics_3fo_feature(Nyxus::Feature3D::P10, "3P10"));
}

TEST(TEST_NYXUS, TEST_3D_FIRSTORDER_P90_PYRADIOMICS){
	ASSERT_NO_THROW (assert_compat_radiomics_3fo_feature(Nyxus::Feature3D::P90, "3P90"));
}

TEST(TEST_NYXUS, TEST_3D_FIRSTORDER_ENERGY_PYRADIOMICS){
	ASSERT_NO_THROW (assert_compat_radiomics_3fo_feature(Nyxus::Feature3D::ENERGY, "3ENERGY"));
}

TEST(TEST_NYXUS, TEST_3D_FIRSTORDER_ENTROPY_PYRADIOMICS){
	ASSERT_NO_THROW (assert_compat_radiomics_3fo_feature(Nyxus::Feature3D::ENTROPY, "3ENTROPY"));
}

TEST(TEST_NYXUS, TEST_3D_FIRSTORDER_INTERQUARTILE_RANGE_PYRADIOMICS){
	ASSERT_NO_THROW (assert_compat_radiomics_3fo_feature(Nyxus::Feature3D::INTERQUARTILE_RANGE, "3INTERQUARTILE_RANGE"));
}

TEST(TEST_NYXUS, TEST_3D_FIRSTORDER_KURTOSIS_PYRADIOMICS){
	ASSERT_NO_THROW (assert_compat_radiomics_3fo_feature(Nyxus::Feature3D::KURTOSIS, "3KURTOSIS"));
}

TEST(TEST_NYXUS, TEST_3D_FIRSTORDER_MAX_PYRADIOMICS){
	ASSERT_NO_THROW (assert_compat_radiomics_3fo_feature(Nyxus::Feature3D::MAX, "3MAX"));
}

TEST(TEST_NYXUS, TEST_3D_FIRSTORDER_MEAN_ABSOLUTE_DEVIATION_PYRADIOMICS){
	ASSERT_NO_THROW (assert_compat_radiomics_3fo_feature(Nyxus::Feature3D::MEAN_ABSOLUTE_DEVIATION, "3MEAN_ABSOLUTE_DEVIATION"));
}

TEST(TEST_NYXUS, TEST_3D_FIRSTORDER_MEAN_PYRADIOMICS){
	ASSERT_NO_THROW (assert_compat_radiomics_3fo_feature(Nyxus::Feature3D::MEAN, "3MEAN"));
}

TEST(TEST_NYXUS, TEST_3D_FIRSTORDER_MEDIAN_PYRADIOMICS){
	ASSERT_NO_THROW (assert_compat_radiomics_3fo_feature(Nyxus::Feature3D::MEDIAN, "3MEDIAN"));
}

TEST(TEST_NYXUS, TEST_3D_FIRSTORDER_MIN_PYRADIOMICS){
	ASSERT_NO_THROW (assert_compat_radiomics_3fo_feature(Nyxus::Feature3D::MIN, "3MIN"));
}

TEST(TEST_NYXUS, TEST_3D_FIRSTORDER_RANGE_PYRADIOMICS){
	ASSERT_NO_THROW (assert_compat_radiomics_3fo_feature(Nyxus::Feature3D::RANGE, "3RANGE"));
}

TEST(TEST_NYXUS, TEST_3D_FIRSTORDER_ROBUST_MEAN_ABSOLUTE_DEVIATION_PYRADIOMICS){
	ASSERT_NO_THROW (assert_compat_radiomics_3fo_feature(Nyxus::Feature3D::ROBUST_MEAN_ABSOLUTE_DEVIATION, "3ROBUST_MEAN_ABSOLUTE_DEVIATION"));
}

TEST(TEST_NYXUS, TEST_3D_FIRSTORDER_ROOT_MEAN_SQUARED_PYRADIOMICS){
	ASSERT_NO_THROW (assert_compat_radiomics_3fo_feature(Nyxus::Feature3D::ROOT_MEAN_SQUARED, "3ROOT_MEAN_SQUARED"));
}

TEST(TEST_NYXUS, TEST_3D_FIRSTORDER_SKEWNESS_PYRADIOMICS){
	ASSERT_NO_THROW (assert_compat_radiomics_3fo_feature(Nyxus::Feature3D::SKEWNESS, "3SKEWNESS"));
}

TEST(TEST_NYXUS, TEST_3D_FIRSTORDER_UNIFORMITY_PYRADIOMICS){
	ASSERT_NO_THROW (assert_compat_radiomics_3fo_feature(Nyxus::Feature3D::UNIFORMITY, "3UNIFORMITY"));
}

TEST(TEST_NYXUS, TEST_3D_FIRSTORDER_VARIANCE_PYRADIOMICS){
	ASSERT_NO_THROW (assert_compat_radiomics_3fo_feature(Nyxus::Feature3D::VARIANCE, "3VARIANCE"));
}
...
TEST(TEST_NYXUS, TEST_3D_GLCM_ANGULAR_2D_MOMENT_PYRADIOMICS) {
	ASSERT_NO_THROW(test_3d_glcm_angular_2d_moment_pyradiomics());
}
...
TEST(TEST_NYXUS, TEST_ARROW_FILE_NAME_MECHANICS){
	test_arrow_file_name_mechanics();
}

TEST(TEST_NYXUS, TEST_ARROW_MECHANICS) {
	test_arrow_mechanics();
}
...
TEST(TEST_NYXUS, TEST_3D_GLDZM_GLM_IBSI) {
	ASSERT_NO_THROW(test_3d_gldzm_glm_ibsi());
}

TEST(TEST_NYXUS, TEST_3D_GLDZM_GLV_IBSI) {
	ASSERT_NO_THROW(test_3d_gldzm_glv_ibsi());
}

TEST(TEST_NYXUS, TEST_3D_GLDZM_LDE_IBSI) {
	ASSERT_NO_THROW(test_3d_gldzm_lde_ibsi());
}

TEST(TEST_NYXUS, TEST_3D_GLDZM_SDE_IBSI) {
	ASSERT_NO_THROW(test_3d_gldzm_sde_ibsi());
}

TEST(TEST_NYXUS, TEST_3D_GLDZM_LGLZE_IBSI) {
	ASSERT_NO_THROW(test_3d_gldzm_lglze_ibsi());
}

TEST(TEST_NYXUS, TEST_3D_GLDZM_HGLZE_IBSI) {
	ASSERT_NO_THROW(test_3d_gldzm_hglze_ibsi());
}

TEST(TEST_NYXUS, TEST_3D_GLDZM_SDLGLE_IBSI) {
	ASSERT_NO_THROW(test_3d_gldzm_sdlgle_ibsi());
}

TEST(TEST_NYXUS, TEST_3D_GLDZM_SDHGLE_IBSI) {
	ASSERT_NO_THROW(test_3d_gldzm_sdhgle_ibsi());
}

TEST(TEST_NYXUS, TEST_3D_GLDZM_LDLGLE_IBSI) {
	ASSERT_NO_THROW(test_3d_gldzm_ldlgle_ibsi());
}

TEST(TEST_NYXUS, TEST_3D_GLDZM_LDHGLE_IBSI) {
	ASSERT_NO_THROW(test_3d_gldzm_ldhgle_ibsi());
}

TEST(TEST_NYXUS, TEST_3D_GLDZM_GLNU_IBSI) {
	ASSERT_NO_THROW(test_3d_gldzm_glnu_ibsi());
}

TEST(TEST_NYXUS, TEST_3D_GLDZM_GLNUN_IBSI) {
	ASSERT_NO_THROW(test_3d_gldzm_glnun_ibsi());
}

TEST(TEST_NYXUS, TEST_3D_GLDZM_ZDNU_IBSI) {
	ASSERT_NO_THROW(test_3d_gldzm_zdnu_ibsi());
}

TEST(TEST_NYXUS, TEST_3D_GLDZM_ZDNUN_IBSI) {
	ASSERT_NO_THROW(test_3d_gldzm_zdnun_ibsi());
}

TEST(TEST_NYXUS, TEST_3D_GLDZM_ZDV_IBSI) {
	ASSERT_NO_THROW(test_3d_gldzm_zdv_ibsi());
}

TEST(TEST_NYXUS, TEST_3D_GLDZM_ZP_IBSI) {
	ASSERT_NO_THROW(test_3d_gldzm_zp_ibsi());
}

TEST(TEST_NYXUS, TEST_3D_GLDZM_ZDE_IBSI) {
	ASSERT_NO_THROW(test_3d_gldzm_zde_ibsi());
}
...
TEST(TEST_NYXUS, TEST_FIRSTORDER_INTEGRATED_INTENSITY_REGRESSION)
{
	ASSERT_NO_THROW(test_firstorder_integrated_intensity_regression());
}

TEST(TEST_NYXUS, TEST_FIRSTORDER_MIN_MAX_RANGE_REGRESSION) 
{
	ASSERT_NO_THROW(test_firstorder_min_max_range_regression());
}

TEST(TEST_NYXUS, TEST_FIRSTORDER_MEAN_REGRESSION) 
{
	ASSERT_NO_THROW(test_firstorder_mean_regression());
}

TEST(TEST_NYXUS, TEST_FIRSTORDER_COV_REGRESSION)
{
	ASSERT_NO_THROW(test_firstorder_cov_regression());
}

TEST(TEST_NYXUS, TEST_FIRSTORDER_MEDIAN_REGRESSION) 
{
	ASSERT_NO_THROW(test_firstorder_median_regression());
}

TEST(TEST_NYXUS, TEST_FIRSTORDER_MODE_REGRESSION) 
{
	ASSERT_NO_THROW(test_firstorder_mode_regression());
}

TEST(TEST_NYXUS, TEST_FIRSTORDER_STANDARD_DEVIATION_REGRESSION){
	ASSERT_NO_THROW(test_firstorder_standard_deviation_regression());
}

TEST(TEST_NYXUS, TEST_FIRSTORDER_STANDARD_DEVIATION_BIASED_REGRESSION){
	ASSERT_NO_THROW(test_firstorder_standard_deviation_biased_regression());
}

TEST(TEST_NYXUS, TEST_FIRSTORDER_VARIANCE_REGRESSION)
{
	ASSERT_NO_THROW(test_firstorder_variance_regression());
}
...
TEST(TEST_NYXUS, TEST_INTENSITY_HISTOGRAM_IBSI_GATE_OFF_RETURNS_NAN_REGRESSION)
{
	ASSERT_NO_THROW(test_intensity_histogram_ibsi_gate_off_returns_nan_regression());
}

TEST(TEST_NYXUS, TEST_INTENSITY_HISTOGRAM_FLOAT_DOMAIN_RECONSTRUCTION_REGRESSION)
{
	ASSERT_NO_THROW(test_intensity_histogram_float_domain_reconstruction_regression());
}

TEST(TEST_NYXUS, TEST_INTENSITY_HISTOGRAM_FLOAT_DOMAIN_RECONSTRUCTION_NEGATIVE_MIN_REGRESSION)
{
	ASSERT_NO_THROW(test_intensity_histogram_float_domain_reconstruction_negative_min_regression());
}

TEST(TEST_NYXUS, TEST_INTENSITY_HISTOGRAM_FLOAT_DOMAIN_RECONSTRUCTION_PRESERVE_HU_REGRESSION)
{
	ASSERT_NO_THROW(test_intensity_histogram_float_domain_reconstruction_preserve_hu_regression());
}

TEST(TEST_NYXUS, TEST_INTENSITY_HISTOGRAM_FLOAT_DOMAIN_RECONSTRUCTION_PRESERVE_HU_FPACTIVE_REGRESSION)
{
	ASSERT_NO_THROW(test_intensity_histogram_float_domain_reconstruction_preserve_hu_fpactive_regression());
}

TEST(TEST_NYXUS, TEST_INTENSITY_HISTOGRAM_REQUIRED_PREDICATE_REGRESSION)
{
	ASSERT_NO_THROW(test_intensity_histogram_required_predicate_regression());
}
...
TEST(TEST_NYXUS, TEST_FIRSTORDER_VARIANCE_BIASED_REGRESSION)
{
	ASSERT_NO_THROW(test_firstorder_variance_biased_regression());
}

TEST(TEST_NYXUS, TEST_FIRSTORDER_SKEWNESS_REGRESSION) 
{
	ASSERT_NO_THROW(test_firstorder_skewness_regression());
}

TEST(TEST_NYXUS, TEST_FIRSTORDER_KURTOSIS_REGRESSION){
	ASSERT_NO_THROW(test_firstorder_kurtosis_regression());
}

TEST(TEST_NYXUS, TEST_FIRSTORDER_PEARSON_KURTOSIS_REGRESSION){
	ASSERT_NO_THROW(test_firstorder_pearson_kurtosis_regression());
}

TEST(TEST_NYXUS, TEST_FIRSTORDER_HYPERSKEWNESS_REGRESSION)
{
	ASSERT_NO_THROW(test_firstorder_hyperskewness_regression());
}

TEST(TEST_NYXUS, TEST_FIRSTORDER_HYPERFLATNESS_REGRESSION)
{
	ASSERT_NO_THROW(test_firstorder_hyperflatness_regression());
}

TEST(TEST_NYXUS, TEST_FIRSTORDER_MEAN_ABSOLUTE_DEVIATION_REGRESSION){
	ASSERT_NO_THROW(test_firstorder_mean_absolute_deviation_regression());
}

TEST(TEST_NYXUS, TEST_FIRSTORDER_MEDIAN_ABSOLUTE_DEVIATION_REGRESSION)
{
	ASSERT_NO_THROW(test_firstorder_median_absolute_deviation_regression());
}

TEST(TEST_NYXUS, TEST_FIRSTORDER_ROBUST_MEAN_REGRESSION)
{
	ASSERT_NO_THROW(test_firstorder_robust_mean_regression());
}

TEST(TEST_NYXUS, TEST_FIRSTORDER_ROBUST_MEAN_ABSOLUTE_DEVIATION_REGRESSION){
	ASSERT_NO_THROW(test_firstorder_robust_mean_absolute_deviation_regression());
}

TEST(TEST_NYXUS, TEST_FIRSTORDER_STANDARD_ERROR_REGRESSION) 
{
	ASSERT_NO_THROW(test_firstorder_standard_error_regression());
}

TEST(TEST_NYXUS, TEST_FIRSTORDER_ROOT_MEAN_SQUARED_REGRESSION){
	ASSERT_NO_THROW(test_firstorder_root_mean_squared_regression());
}
...
TEST(TEST_NYXUS, TEST_FIRSTORDER_ENERGY_REGRESSION) 
{
	ASSERT_NO_THROW(test_firstorder_energy_regression());
}

TEST(TEST_NYXUS, TEST_FIRSTORDER_UNIFORMITY_REGRESSION) 
{
	ASSERT_NO_THROW(test_firstorder_uniformity_regression());
}

TEST(TEST_NYXUS, TEST_FIRSTORDER_UNIFORMITY_PIU_REGRESSION)
{
	ASSERT_NO_THROW(test_firstorder_uniformity_piu_regression());
}

TEST(TEST_NYXUS, TEST_FIRSTORDER_PERCENTILES_IQR_REGRESSION)
{
	ASSERT_NO_THROW(test_firstorder_percentiles_iqr_regression());
}

TEST(TEST_NYXUS, TEST_FIRSTORDER_QCOD_REGRESSION)
{
	ASSERT_NO_THROW(test_firstorder_qcod_regression());
}

TEST(TEST_NYXUS, TEST_FIRSTORDER_COVERED_IMAGE_RANGE_REGRESSION)
{
	ASSERT_NO_THROW(test_firstorder_covered_image_range_regression());
}
...
TEST(TEST_NYXUS, TEST_INTENSITY_HISTOGRAM_RADIAL_DISTRIBUTION_REGRESSION){
	ASSERT_NO_THROW(test_intensity_histogram_radial_distribution_regression());
}
...
TEST(TEST_NYXUS, TEST_GLCM_ACOR_IBSI)
{
	ASSERT_NO_THROW(test_glcm_acor_ibsi());
}

TEST(TEST_NYXUS, TEST_GLCM_ANGULAR_2D_MOMENT_IBSI)
{
	ASSERT_NO_THROW(test_glcm_angular_2d_moment_ibsi());
}

TEST(TEST_NYXUS, TEST_GLCM_CLUPROM_IBSI)
{
	ASSERT_NO_THROW(test_glcm_cluprom_ibsi());
}

TEST(TEST_NYXUS, TEST_GLCM_CLUSHADE_IBSI)
{
	ASSERT_NO_THROW(test_glcm_clushade_ibsi());
}

TEST(TEST_NYXUS, TEST_GLCM_CLUTEND_IBSI)
{
	ASSERT_NO_THROW(test_glcm_clutend_ibsi());
}

TEST(TEST_NYXUS, TEST_GLCM_CONTRAST_IBSI){
	ASSERT_NO_THROW(test_glcm_contrast_ibsi());
}

TEST(TEST_NYXUS, TEST_GLCM_CORRELATION_IBSI)
{
	ASSERT_NO_THROW(test_glcm_correlation_ibsi());
}

TEST(TEST_NYXUS, TEST_GLCM_DIFFERENCE_AVERAGE_IBSI)
{
	ASSERT_NO_THROW(test_glcm_difference_average_ibsi());
}

TEST(TEST_NYXUS, TEST_GLCM_DIFFERENCE_VARIANCE_IBSI)
{
	ASSERT_NO_THROW(test_glcm_difference_variance_ibsi());
}

TEST(TEST_NYXUS, TEST_GLCM_DIFFERENCE_ENTROPY_IBSI)
{
	ASSERT_NO_THROW(test_glcm_difference_entropy_ibsi());
}

TEST(TEST_NYXUS, TEST_GLCM_DIS_IBSI)
{
	ASSERT_NO_THROW(test_glcm_dis_ibsi());
}

TEST(TEST_NYXUS, TEST_GLCM_ID_IBSI){
	ASSERT_NO_THROW(test_glcm_id_ibsi());
}

TEST(TEST_NYXUS, TEST_GLCM_IDN_IBSI){
	ASSERT_NO_THROW(test_glcm_idn_ibsi());
}

TEST(TEST_NYXUS, TEST_GLCM_IDM_IBSI){
	ASSERT_NO_THROW(test_glcm_idm_ibsi());
}

TEST(TEST_NYXUS, TEST_GLCM_IDMN_IBSI){
	ASSERT_NO_THROW(test_glcm_idmn_ibsi());
}

TEST(TEST_NYXUS, TEST_GLCM_INFOMEAS1_IBSI)
{
	ASSERT_NO_THROW(test_glcm_infomeas1_ibsi());
}

TEST(TEST_NYXUS, TEST_GLCM_INFOMEAS2_IBSI)
{
	ASSERT_NO_THROW(test_glcm_infomeas2_ibsi());
}

TEST(TEST_NYXUS, TEST_GLCM_INVERSED_DIFFERENCE_MOMENT_IBSI)
{
	ASSERT_NO_THROW(test_glcm_inversed_difference_moment_ibsi());
}

TEST(TEST_NYXUS, TEST_GLCM_IV_IBSI)
{
	ASSERT_NO_THROW(test_glcm_iv_ibsi());
}

TEST(TEST_NYXUS, TEST_GLCM_JAVE_IBSI)
{
	ASSERT_NO_THROW(test_glcm_jave_ibsi());
}

TEST(TEST_NYXUS, TEST_GLCM_JE_IBSI)
{
	ASSERT_NO_THROW(test_glcm_je_ibsi());
}

TEST(TEST_NYXUS, TEST_GLCM_HOM2_IBSI)
{
	ASSERT_NO_THROW(test_glcm_hom2_ibsi());
}

TEST(TEST_NYXUS, TEST_GLCM_ENTROPY_IBSI)
{
	ASSERT_NO_THROW(test_glcm_entropy_ibsi());
}

TEST(TEST_NYXUS, TEST_GLCM_JMAX_IBSI)
{
	ASSERT_NO_THROW(test_glcm_jmax_ibsi());
}

TEST(TEST_NYXUS, TEST_GLCM_JVAR_IBSI)
{
	ASSERT_NO_THROW(test_glcm_jvar_ibsi());
}

TEST(TEST_NYXUS, TEST_GLCM_SUM_AVERAGE_IBSI) 
{
	ASSERT_NO_THROW(test_glcm_sum_average_ibsi());
}

TEST(TEST_NYXUS, TEST_GLCM_SUM_VARIANCE_IBSI)
{
	ASSERT_NO_THROW(test_glcm_sum_variance_ibsi());
}

TEST(TEST_NYXUS, TEST_GLCM_SUM_ENTROPY_IBSI)
{
	ASSERT_NO_THROW(test_glcm_sum_entropy_ibsi());
}


//***** 2D GLCM regression ***** 

TEST(TEST_NYXUS, TEST_GLCM_ACOR_REGRESSION)
{
	ASSERT_NO_THROW(test_glcm_acor_regression());
}

TEST(TEST_NYXUS, TEST_GLCM_ANGULAR_2D_MOMENT_REGRESSION){
	ASSERT_NO_THROW(test_glcm_angular_2d_moment_regression());
}

TEST(TEST_NYXUS, TEST_GLCM_CLUPROM_REGRESSION)
{
	ASSERT_NO_THROW(test_glcm_cluprom_regression());
}

TEST(TEST_NYXUS, TEST_GLCM_CLUSHADE_REGRESSION)
{
	ASSERT_NO_THROW(test_glcm_clushade_regression());
}

TEST(TEST_NYXUS, TEST_GLCM_CLUTEND_REGRESSION)
{
	ASSERT_NO_THROW(test_glcm_clutend_regression());
}

TEST(TEST_NYXUS, TEST_GLCM_CONTRAST_REGRESSION)
{
	ASSERT_NO_THROW(test_glcm_contrast_regression());
}

TEST(TEST_NYXUS, TEST_GLCM_CORRELATION_REGRESSION)
{
	ASSERT_NO_THROW(test_glcm_correlation_regression());
}

TEST(TEST_NYXUS, TEST_GLCM_DIFFERENCE_AVERAGE_REGRESSION){
	ASSERT_NO_THROW(test_glcm_difference_average_regression());
}

TEST(TEST_NYXUS, TEST_GLCM_DIFFERENCE_ENTROPY_REGRESSION){
	ASSERT_NO_THROW(test_glcm_difference_entropy_regression());
}

TEST(TEST_NYXUS, TEST_GLCM_DIFFERENCE_VARIANCE_REGRESSION){
	ASSERT_NO_THROW(test_glcm_difference_variance_regression());
}

TEST(TEST_NYXUS, TEST_GLCM_DIS_REGRESSION)
{
	ASSERT_NO_THROW(test_glcm_dis_regression());
}

TEST(TEST_NYXUS, TEST_GLCM_ENERGY_REGRESSION)
{
	ASSERT_NO_THROW(test_glcm_energy_regression());
}

TEST(TEST_NYXUS, TEST_GLCM_ENTROPY_REGRESSION)
{
	ASSERT_NO_THROW(test_glcm_entropy_regression());
}

TEST(TEST_NYXUS, TEST_GLCM_HOM1_REGRESSION)
{
	ASSERT_NO_THROW(test_glcm_hom1_regression());
}

TEST(TEST_NYXUS, TEST_GLCM_HOM2_REGRESSION)
{
	ASSERT_NO_THROW(test_glcm_hom2_regression());
}

TEST(TEST_NYXUS, TEST_GLCM_ID_REGRESSION)
{
	ASSERT_NO_THROW(test_glcm_id_regression());
}

TEST(TEST_NYXUS, TEST_GLCM_IDN_REGRESSION)
{
	ASSERT_NO_THROW(test_glcm_idn_regression());
}

TEST(TEST_NYXUS, TEST_GLCM_IDM_REGRESSION)
{
	ASSERT_NO_THROW(test_glcm_idm_regression());
}

TEST(TEST_NYXUS, TEST_GLCM_IDMN_REGRESSION)
{
	ASSERT_NO_THROW(test_glcm_idmn_regression());
}

TEST(TEST_NYXUS, TEST_GLCM_INFOMEAS1_REGRESSION)
{
	ASSERT_NO_THROW(test_glcm_infomeas1_regression());
}

TEST(TEST_NYXUS, TEST_GLCM_INFOMEAS2_REGRESSION)
{
	ASSERT_NO_THROW(test_glcm_infomeas2_regression());
}

TEST(TEST_NYXUS, TEST_GLCM_IV_REGRESSION)
{
	ASSERT_NO_THROW(test_glcm_iv_regression());
}

TEST(TEST_NYXUS, TEST_GLCM_JAVE_REGRESSION)
{
	ASSERT_NO_THROW(test_glcm_jave_regression());
}

TEST(TEST_NYXUS, TEST_GLCM_JE_REGRESSION)
{
	ASSERT_NO_THROW(test_glcm_je_regression());
}

TEST(TEST_NYXUS, TEST_GLCM_JMAX_REGRESSION)
{
	ASSERT_NO_THROW(test_glcm_jmax_regression());
}

TEST(TEST_NYXUS, TEST_GLCM_JVAR_REGRESSION)
{
	ASSERT_NO_THROW(test_glcm_jvar_regression());
}

TEST(TEST_NYXUS, TEST_GLCM_SUM_AVERAGE_REGRESSION){
	ASSERT_NO_THROW(test_glcm_sum_average_regression());
}

TEST(TEST_NYXUS, TEST_GLCM_SUM_ENTROPY_REGRESSION){
	ASSERT_NO_THROW(test_glcm_sum_entropy_regression());
}

TEST(TEST_NYXUS, TEST_GLCM_SUM_VARIANCE_REGRESSION){
	ASSERT_NO_THROW(test_glcm_sum_variance_regression());
}

TEST(TEST_NYXUS, TEST_GLCM_VARIANCE_REGRESSION)
{
	ASSERT_NO_THROW(test_glcm_variance_regression());
}

TEST(TEST_NYXUS, TEST_GLCM_ASM_AVE_REGRESSION)
{
	ASSERT_NO_THROW(test_glcm_asm_ave_regression());
}

TEST(TEST_NYXUS, TEST_GLCM_ACOR_AVE_REGRESSION)
{
	ASSERT_NO_THROW(test_glcm_acor_ave_regression());
}

TEST(TEST_NYXUS, TEST_GLCM_CLUPROM_AVE_REGRESSION)
{
	ASSERT_NO_THROW(test_glcm_cluprom_ave_regression());
}

TEST(TEST_NYXUS, TEST_GLCM_CLUSHADE_AVE_REGRESSION)
{
	ASSERT_NO_THROW(test_glcm_clushade_ave_regression());
}

TEST(TEST_NYXUS, TEST_GLCM_CLUTEND_AVE_REGRESSION)
{
	ASSERT_NO_THROW(test_glcm_clutend_ave_regression());
}

TEST(TEST_NYXUS, TEST_GLCM_CONTRAST_AVE_REGRESSION)
{
	ASSERT_NO_THROW(test_glcm_contrast_ave_regression());
}

TEST(TEST_NYXUS, TEST_GLCM_CORRELATION_AVE_REGRESSION)
{
	ASSERT_NO_THROW(test_glcm_correlation_ave_regression());
}

TEST(TEST_NYXUS, TEST_GLCM_DIFAVE_AVE_REGRESSION)
{
	ASSERT_NO_THROW(test_glcm_difave_ave_regression());
}

TEST(TEST_NYXUS, TEST_GLCM_DIFENTRO_AVE_REGRESSION)
{
	ASSERT_NO_THROW(test_glcm_difentro_ave_regression());
}

TEST(TEST_NYXUS, TEST_GLCM_DIFVAR_AVE_REGRESSION)
{
	ASSERT_NO_THROW(test_glcm_difvar_ave_regression());
}

TEST(TEST_NYXUS, TEST_GLCM_DIS_AVE_REGRESSION)
{
	ASSERT_NO_THROW(test_glcm_dis_ave_regression());
}

TEST(TEST_NYXUS, TEST_GLCM_ENERGY_AVE_REGRESSION)
{
	ASSERT_NO_THROW(test_glcm_energy_ave_regression());
}

TEST(TEST_NYXUS, TEST_GLCM_ENTROPY_AVE_REGRESSION)
{
	ASSERT_NO_THROW(test_glcm_entropy_ave_regression());
}

TEST(TEST_NYXUS, TEST_GLCM_HOM1_AVE_REGRESSION)
{
	ASSERT_NO_THROW(test_glcm_hom1_ave_regression());
}

TEST(TEST_NYXUS, TEST_GLCM_ID_AVE_REGRESSION)
{
	ASSERT_NO_THROW(test_glcm_id_ave_regression());
}

TEST(TEST_NYXUS, TEST_GLCM_IDN_AVE_REGRESSION)
{
	ASSERT_NO_THROW(test_glcm_idn_ave_regression());
}

TEST(TEST_NYXUS, TEST_GLCM_IDM_AVE_REGRESSION)
{
	ASSERT_NO_THROW(test_glcm_idm_ave_regression());
}

TEST(TEST_NYXUS, TEST_GLCM_IDMN_AVE_REGRESSION)
{
	ASSERT_NO_THROW(test_glcm_idmn_ave_regression());
}

TEST(TEST_NYXUS, TEST_GLCM_IV_AVE_REGRESSION)
{
	ASSERT_NO_THROW(test_glcm_iv_ave_regression());
}

TEST(TEST_NYXUS, TEST_GLCM_JAVE_AVE_REGRESSION)
{
	ASSERT_NO_THROW(test_glcm_jave_ave_regression());
}

TEST(TEST_NYXUS, TEST_GLCM_JE_AVE_REGRESSION)
{
	ASSERT_NO_THROW(test_glcm_je_ave_regression());
}

TEST(TEST_NYXUS, TEST_GLCM_INFOMEAS1_AVE_REGRESSION)
{
	ASSERT_NO_THROW(test_glcm_infomeas1_ave_regression());
}

TEST(TEST_NYXUS, TEST_GLCM_INFOMEAS2_AVE_REGRESSION)
{
	ASSERT_NO_THROW(test_glcm_infomeas2_ave_regression());
}

TEST(TEST_NYXUS, TEST_GLCM_VARIANCE_AVE_REGRESSION)
{
	ASSERT_NO_THROW(test_glcm_variance_ave_regression());
}

TEST(TEST_NYXUS, TEST_GLCM_JMAX_AVE_REGRESSION)
{
	ASSERT_NO_THROW(test_glcm_jmax_ave_regression());
}

TEST(TEST_NYXUS, TEST_GLCM_JVAR_AVE_REGRESSION)
{
	ASSERT_NO_THROW(test_glcm_jvar_ave_regression());
}

TEST(TEST_NYXUS, TEST_GLCM_SUMAVERAGE_AVE_REGRESSION)
{
	ASSERT_NO_THROW(test_glcm_sumaverage_ave_regression());
}

TEST(TEST_NYXUS, TEST_GLCM_SUMENTROPY_AVE_REGRESSION)
{
	ASSERT_NO_THROW(test_glcm_sumentropy_ave_regression());
}

TEST(TEST_NYXUS, TEST_GLCM_SUMVARIANCE_AVE_REGRESSION)
{
	ASSERT_NO_THROW(test_glcm_sumvariance_ave_regression());
}
...
TEST(TEST_NYXUS, TEST_GLCM_BUG_OFFSET_DEFAULT_IS_ONE_MECHANICS){
	ASSERT_NO_THROW(test_glcm_bug_offset_default_is_one_mechanics());
}
...
TEST(TEST_NYXUS, TEST_IMQ_POWER_SPECTRUM_REGRESSION){
	ASSERT_NO_THROW(test_imq_power_spectrum_regression());
}
