...
TEST(TEST_NYXUS, TEST_2D_MORPHOLOGY_PERIMETER_MATLAB) 
{
	ASSERT_NO_THROW(test_2d_morphology_perimeter_matlab());
}
...
TEST(TEST_NYXUS, TEST_2D_NGLDM_MATRIX_CORRECTNESS_NONIBSI_MODE_IBSI)
{
	ASSERT_NO_THROW(test_2d_ngldm_matrix_correctness_nonibsi_mode_ibsi());
}
...
TEST(TEST_NYXUS, TEST_2D_FIRSTORDER_ROBUST_MEAN_MATLAB)
{
	ASSERT_NO_THROW(test_2d_firstorder_robust_mean_matlab());
}
...
TEST(TEST_NYXUS, TEST_2D_FIRSTORDER_P01_MATLAB)
{
	ASSERT_NO_THROW(test_2d_firstorder_p01_matlab());
}
TEST(TEST_NYXUS, TEST_2D_FIRSTORDER_P10_MATLAB)
{
	ASSERT_NO_THROW(test_2d_firstorder_p10_matlab());
}
TEST(TEST_NYXUS, TEST_2D_FIRSTORDER_P25_MATLAB)
{
	ASSERT_NO_THROW(test_2d_firstorder_p25_matlab());
}
TEST(TEST_NYXUS, TEST_2D_FIRSTORDER_P75_MATLAB)
{
	ASSERT_NO_THROW(test_2d_firstorder_p75_matlab());
}
TEST(TEST_NYXUS, TEST_2D_FIRSTORDER_P90_MATLAB)
{
	ASSERT_NO_THROW(test_2d_firstorder_p90_matlab());
}
TEST(TEST_NYXUS, TEST_2D_FIRSTORDER_P99_MATLAB)
{
	ASSERT_NO_THROW(test_2d_firstorder_p99_matlab());
}
...
TEST(TEST_NYXUS, TEST_2D_FIRSTORDER_QCOD_MATLAB)
{
	ASSERT_NO_THROW(test_2d_firstorder_qcod_matlab());
}
