...
TEST(TEST_NYXUS, TEST_COMPAT_3GLCM_DIS) {
	ASSERT_NO_THROW(test_compat_3glcm_DIS());
}
...
TEST(TEST_NYXUS, TEST_COMPAT_3GLCM_JVAR) {
	ASSERT_NO_THROW(test_compat_3glcm_JVAR());
}
...
TEST(TEST_NYXUS, TEST_COMPAT_3GLCM_SUM_VARIANCE) {
	ASSERT_NO_THROW(test_compat_3glcm_sum_variance());
}
