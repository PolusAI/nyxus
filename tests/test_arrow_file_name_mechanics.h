...
void assert_file_naming_case_1 (const fs::path& temp_dir);
void assert_file_naming_case_2 (const fs::path& temp_dir);
void assert_file_naming_case_3 (const fs::path& temp_dir);
void assert_file_naming_case_4 (const fs::path& temp_dir);
void assert_file_naming_case_5 (const fs::path& temp_dir);
void assert_file_naming_case_6 (const fs::path& temp_dir);

void test_arrow_file_name_mechanics () {
    ...
    assert_file_naming_case_1(temp);
    assert_file_naming_case_2(temp);
    assert_file_naming_case_3(temp);
    assert_file_naming_case_4(temp);
    assert_file_naming_case_5(temp);
    assert_file_naming_case_6(temp);
