...
// kind (SPEC 6.1): the kind belongs to the files that include it - test_firstorder_matlab.h,
// test_firstorder_pyradiomics.h, test_firstorder_ibsi.h and test_firstorder_regression.h.
