...
// test_firstorder_matlab.h in target_test. Same shape as test_firstorder_ibsi.h - one keyed golden
...
// target_test=test_firstorder_regression.h, yet the value below is MATLAB's. Moving it into a file
...
static std::unordered_map<std::string, double> matlab_reference_firstorder_feature_golden_values {
                                      ...
                                      int slide_idx = -1, double slide_min = -1.0, double slide_max = -1.0)
{
    ...
    ASSERT_TRUE(agrees_gt(fvals[(int)feature][0],
                          matlab_reference_firstorder_feature_golden_values[feature_name],
                          frac_tolerance));
}

void test_firstorder_hyperskewness_matlab()
{
    assert_firstorder_feature_matlab(Nyxus::Feature2D::HYPERSKEWNESS, "HYPERSKEWNESS");
}
void test_firstorder_hyperflatness_matlab()
{
...
void test_firstorder_uniformity_matlab()
{
    Fsettings s;
...
void test_firstorder_uniformity_piu_matlab()
{
...
void test_firstorder_covered_image_intensity_range_matlab()
{
