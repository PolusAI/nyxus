...
void assert_gldm_feature(const Feature2D& feature, const std::string& feature_name) 
{
...
{
    assert_gldm_feature(Nyxus::Feature2D::GLDM_SDE, "GLDM_SDE");
}

void test_gldm_lde_regression()
{
   assert_gldm_feature(Nyxus::Feature2D::GLDM_LDE, "GLDM_LDE");
}

void test_gldm_lgle_regression()
{
   assert_gldm_feature(Nyxus::Feature2D::GLDM_LGLE, "GLDM_LGLE");
}

void test_gldm_hgle_regression()
{
    assert_gldm_feature(Nyxus::Feature2D::GLDM_HGLE, "GLDM_HGLE");
}

void test_gldm_sdlgle_regression()
{
    assert_gldm_feature(Nyxus::Feature2D::GLDM_SDLGLE, "GLDM_SDLGLE");    
}

void test_gldm_sdhgle_regression()
{
    assert_gldm_feature(Nyxus::Feature2D::GLDM_SDHGLE, "GLDM_SDHGLE");
}

void test_gldm_ldlgle_regression()
{
    assert_gldm_feature(Nyxus::Feature2D::GLDM_LDLGLE, "GLDM_LDLGLE");
}

void test_gldm_ldhgle_regression()
{
    assert_gldm_feature(Nyxus::Feature2D::GLDM_LDHGLE, "GLDM_LDHGLE");
}

void test_gldm_gln_regression()
{
   assert_gldm_feature(Nyxus::Feature2D::GLDM_GLN, "GLDM_GLN");
}

void test_gldm_dn_regression()
{
    assert_gldm_feature(Nyxus::Feature2D::GLDM_DN, "GLDM_DN");
}

void test_gldm_dnn_regression()
{
    assert_gldm_feature(Nyxus::Feature2D::GLDM_DNN, "GLDM_DNN");
}

void test_gldm_glv_regression()
{
    assert_gldm_feature(Nyxus::Feature2D::GLDM_GLV, "GLDM_GLV");
}

void test_gldm_dv_regression()
{
    assert_gldm_feature(Nyxus::Feature2D::GLDM_DV, "GLDM_DV");
}

void test_gldm_de_regression()
{
    assert_gldm_feature(Nyxus::Feature2D::GLDM_DE, "GLDM_DE");
}
