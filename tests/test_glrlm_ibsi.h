...
void assert_ibsi_glrlm_feature(const Feature2D& feature_, const std::string& feature_name) 
{
...
{
    assert_ibsi_glrlm_feature(Nyxus::Feature2D::GLRLM_SRE, "GLRLM_SRE");
}

void test_glrlm_lre_ibsi()
{
    assert_ibsi_glrlm_feature(Nyxus::Feature2D::GLRLM_LRE, "GLRLM_LRE");
}

void test_glrlm_lglre_ibsi()
{
    assert_ibsi_glrlm_feature(Nyxus::Feature2D::GLRLM_LGLRE, "GLRLM_LGLRE");
}

void test_glrlm_hglre_ibsi()
{
    assert_ibsi_glrlm_feature(Nyxus::Feature2D::GLRLM_HGLRE, "GLRLM_HGLRE");
}   

void test_glrlm_srlgle_ibsi()
{
    assert_ibsi_glrlm_feature(Nyxus::Feature2D::GLRLM_SRLGLE, "GLRLM_SRLGLE");
}

void test_glrlm_srhgle_ibsi()
{
    assert_ibsi_glrlm_feature(Nyxus::Feature2D::GLRLM_SRHGLE, "GLRLM_SRHGLE");
}

void test_glrlm_lrlgle_ibsi()
{
    assert_ibsi_glrlm_feature(Nyxus::Feature2D::GLRLM_LRLGLE, "GLRLM_LRLGLE");
}

void test_glrlm_lrhgle_ibsi()
{
    assert_ibsi_glrlm_feature(Nyxus::Feature2D::GLRLM_LRHGLE, "GLRLM_LRHGLE");
}

void test_glrlm_gln_ibsi()
{   
    assert_ibsi_glrlm_feature(Nyxus::Feature2D::GLRLM_GLN, "GLRLM_GLN");
}

void test_glrlm_glnn_ibsi()
{
    assert_ibsi_glrlm_feature(Nyxus::Feature2D::GLRLM_GLNN, "GLRLM_GLNN");
}

void test_glrlm_rln_ibsi()
{
    assert_ibsi_glrlm_feature(Nyxus::Feature2D::GLRLM_RLN, "GLRLM_RLN");
}

void test_glrlm_rlnn_ibsi()
{
    assert_ibsi_glrlm_feature(Nyxus::Feature2D::GLRLM_RLNN, "GLRLM_RLNN");
}

void test_glrlm_rp_ibsi()
{
    assert_ibsi_glrlm_feature(Nyxus::Feature2D::GLRLM_RP, "GLRLM_RP");
}

void test_glrlm_glv_ibsi()
{
    assert_ibsi_glrlm_feature(Nyxus::Feature2D::GLRLM_GLV, "GLRLM_GLV");
}

void test_glrlm_rv_ibsi()
{
    assert_ibsi_glrlm_feature(Nyxus::Feature2D::GLRLM_RV, "GLRLM_RV");
}

void test_glrlm_re_ibsi()
{
    assert_ibsi_glrlm_feature(Nyxus::Feature2D::GLRLM_RE, "GLRLM_RE");
}
...
void assert_ibsi_glrlm_ave_feature(const Feature2D& feature_, const std::string& ibsi_key)
{
    Fsettings s;
    s.resize((int)NyxSetting::__COUNT__);
    s[(int)NyxSetting::SOFTNAN].rval = 0.0;
...
void test_glrlm_lglre_ave_ibsi()  { assert_ibsi_glrlm_ave_feature(Nyxus::Feature2D::GLRLM_LGLRE_AVE,  "GLRLM_LGLRE"); }
void test_glrlm_hglre_ave_ibsi()  { assert_ibsi_glrlm_ave_feature(Nyxus::Feature2D::GLRLM_HGLRE_AVE,  "GLRLM_HGLRE"); }
void test_glrlm_srlgle_ave_ibsi() { assert_ibsi_glrlm_ave_feature(Nyxus::Feature2D::GLRLM_SRLGLE_AVE, "GLRLM_SRLGLE"); }
void test_glrlm_srhgle_ave_ibsi() { assert_ibsi_glrlm_ave_feature(Nyxus::Feature2D::GLRLM_SRHGLE_AVE, "GLRLM_SRHGLE"); }
void test_glrlm_lrlgle_ave_ibsi() { assert_ibsi_glrlm_ave_feature(Nyxus::Feature2D::GLRLM_LRLGLE_AVE, "GLRLM_LRLGLE"); }
void test_glrlm_lrhgle_ave_ibsi() { assert_ibsi_glrlm_ave_feature(Nyxus::Feature2D::GLRLM_LRHGLE_AVE, "GLRLM_LRHGLE"); }