...
// ---------------------------------------------------------------------------
// Hounsfield-Unit (HU) loader integration tests against real tiled TIFF fixtures.
//
// Fixtures (committed under tests/data/hounsfield) are 16x16,
// single tile, with pixel(r,c) = -1024 + idx*8, idx = r*16 + c (idx 0..255),
// so values span -1024..1016 — a CT/HU-like signed range crossing 0 (water).
//
