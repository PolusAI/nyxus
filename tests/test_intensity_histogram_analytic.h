...
// applies - and they were split out of test_intensity_histogram_ibsi.h, whose goldens are IBSI
...
#include "test_intensity_histogram_regression.h"   // shared fixture: run_intensity_histogram_fixture and the IH settings
