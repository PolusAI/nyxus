...
// test_intensity_histogram_regression.h, whose assertions are pinned feature values.

#include "test_intensity_histogram_regression.h"   // shared fixture: run_intensity_histogram_fixture
