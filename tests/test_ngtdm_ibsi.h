...
void assert_ibsi_ngtdm_feature (const Feature2D& feature_, const std::string& feature_name) 
{
...
void test_ngtdm_coarseness_ibsi()
{
    assert_ibsi_ngtdm_feature(Nyxus::Feature2D::NGTDM_COARSENESS, "NGTDM_COARSENESS");
}

void test_ngtdm_contrast_ibsi()
{
    assert_ibsi_ngtdm_feature(Nyxus::Feature2D::NGTDM_CONTRAST, "NGTDM_CONTRAST");
}

void test_ngtdm_busyness_ibsi()
{
    assert_ibsi_ngtdm_feature(Nyxus::Feature2D::NGTDM_BUSYNESS, "NGTDM_BUSYNESS");
}

void test_ngtdm_complexity_ibsi()
{   
    assert_ibsi_ngtdm_feature(Nyxus::Feature2D::NGTDM_COMPLEXITY, "NGTDM_COMPLEXITY");
}

void test_ngtdm_strength_ibsi()
{
    assert_ibsi_ngtdm_feature(Nyxus::Feature2D::NGTDM_STRENGTH, "NGTDM_STRENGTH");
}