...
void assert_ngtdm_feature(const Feature2D& feature_, const std::string& feature_name) 
{
...
{
    assert_ngtdm_feature(Nyxus::Feature2D::NGTDM_COARSENESS, "NGTDM_COARSENESS");
}

void test_ngtdm_contrast_regression()
{
    assert_ngtdm_feature(Nyxus::Feature2D::NGTDM_CONTRAST, "NGTDM_CONTRAST");
}

void test_ngtdm_busyness_regression()
{
    assert_ngtdm_feature(Nyxus::Feature2D::NGTDM_BUSYNESS, "NGTDM_BUSYNESS");
}

void test_ngtdm_complexity_regression()
{   
    assert_ngtdm_feature(Nyxus::Feature2D::NGTDM_COMPLEXITY, "NGTDM_COMPLEXITY");
}

void test_ngtdm_strength_regression()
{
    assert_ngtdm_feature(Nyxus::Feature2D::NGTDM_STRENGTH, "NGTDM_STRENGTH");
}