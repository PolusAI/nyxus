...
KIND_EXCEPTIONS = {
    "test_intensity_histogram_dispersion_robust_analytic":
        "analytic assertion in the _ibsi file; split needs the IH phantom fixture extracted",
    "test_intensity_histogram_bin_counts_analytic":
        "analytic assertion in the _ibsi file; split needs the IH phantom fixture extracted",
    "test_ngldm_glm_regression":
        "NGLDM_GLM is not an IBSI feature - snapshot GT; split needs the NGLDM helper extracted",
    "test_ngldm_dcm_regression":
        "NGLDM_DCM is not an IBSI feature - snapshot GT; split needs the NGLDM helper extracted",
    "test_morphology_boxcount_known_dimension_analytic":
        "known-dimension shapes are closed form; rides along in the _fraclac module",
    "test_morphology_perimeter_disk_analytic":
        "known-dimension shape is closed form; rides along in the _fraclac module",
    "test_morphology_perimeter_koch_snowflake_analytic":
        "known-dimension shape is closed form; rides along in the _fraclac module",
    "test_neighbor_percent_touching_fully_enclosed_analytic":
        "closed-form 100% case; rides along in the _regression module",
    "test_intensity_histogram_requires_ibsi_mechanics":
        "IH gating check; rides along in the _analytic module",
    "test_intensity_histogram_enabled_with_ibsi_mechanics":
        "IH gating check; rides along in the _analytic module",
    "test_intensity_histogram_index_features_within_bins_invariant":
        "bin-range invariant; rides along in the _analytic module",
    "test_intensity_histogram_mergerois_per_label_default_mechanics":
        "--mergerois API mechanics; rides along in the _analytic module",
    ...
    "test_glcm_contrast_nonzero_by_default_mechanics":
        "offset-default bug guard; rides along in the _pyradiomics module",
}
