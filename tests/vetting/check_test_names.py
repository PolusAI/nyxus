...
# A conforming table is const-qualified before its type, in any of the orders the tree uses:
# "static const T x", "const T x", "inline const T x", and the accessor form "static const T& x()".
