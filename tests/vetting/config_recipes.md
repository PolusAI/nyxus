...
- The `GLDM_GREYDEPTH=0` cell is reachable in production - it is what any settings vector that never
  names the family's own binning gets - and no assertion pins it. Recorded in `matrix/gldm3d.md`.
