"""Generate test_output.csv and test_output.md -- the vetting registry joined to what the tree asserts.
...
OUT_CSV = os.path.join(HERE, "test_output.csv")
OUT_MD = os.path.join(HERE, "test_output.md")
...
def render_md(recs):
    ...
    lines = [
        ...
        "One row per (dim, feature, oracle, config_recipe) in [`test_output.csv`](test_output.csv), joining",
...
def main(argv=None):
    ...
    ap.add_argument("--write", action="store_true", help="regenerate test_output.csv and test_output.md")
